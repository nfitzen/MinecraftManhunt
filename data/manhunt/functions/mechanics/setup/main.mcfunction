...
scoreboard players set $has_started mmh.int 0

execute store result score $hunted_select_left mmh.tmp run data get storage manhunt:settings mmh.mechanics.setup.hunted_size
