...
data modify storage manhunt:default_settings mmh.mechanics.begin set value {"countdown":{"time":10s,"hunted_gamemode":"adventure"},"team_assignment":{"hunted_size":1s}}
...
data modify storage manhunt:default_settings mmh.mechanics.worldborder.set set value {"head_start":{},"setup":{"size":40},"game":{"size":60000000,"center":[0d,0d,0d]}}
